...
ConfigureGraphics::ConfigureGraphics(QWidget* parent)
    ...
    ui->hw_renderer_group->setEnabled(ui->hw_renderer_group->isEnabled() && ui->toggle_hw_renderer->isChecked());
...
void ConfigureGraphics::ApplyConfiguration() {
    ...
    ConfigurationShared::ApplyPerGameSetting(&Settings::values.use_hw_shader,
                                             ui->toggle_hw_shader, use_hw_shader);
    ...
    ConfigurationShared::ApplyPerGameSetting(&Settings::values.shaders_accurate_mul,
                                             ui->toggle_accurate_mul,
                                             shaders_accurate_mul);
    ConfigurationShared::ApplyPerGameSetting(&Settings::values.use_disk_shader_cache,
                                             ui->toggle_disk_shader_cache,
                                             use_disk_shader_cache);
    ConfigurationShared::ApplyPerGameSetting(&Settings::values.use_vsync_new,
                                             ui->toggle_vsync_new,
                                             use_vsync_new);
...
void ConfigureGraphics::SetupPerGameUI() {
    ...
    if (Settings::IsConfiguringGlobal()) {
        ...
        ui->toggle_disk_shader_cache->setEnabled(Settings::values.use_disk_shader_cache.UsingGlobal());
    ...
    ConfigurationShared::SetColoredTristate(ui->toggle_hw_renderer, Settings::values.use_hw_renderer,
                                            use_hw_renderer);
    ConfigurationShared::SetColoredTristate(ui->toggle_hw_shader,
    ...
    ConfigurationShared::SetColoredTristate(ui->toggle_separable_shader,
                                            ...
                                            separable_shader);
    ConfigurationShared::SetColoredTristate(ui->toggle_accurate_mul,
                                            Settings::values.shaders_accurate_mul,
                                            shaders_accurate_mul);
    ConfigurationShared::SetColoredTristate(ui->toggle_disk_shader_cache,
                                            Settings::values.use_disk_shader_cache,
                                            use_disk_shader_cache);
    ConfigurationShared::SetColoredTristate(ui->toggle_vsync_new,
