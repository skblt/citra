...
void Config::ReadRendererValues() {
    ...
    Settings::values.async_command_recording =
        ReadSetting(QStringLiteral("async_command_recording"), true).toBool();
    Settings::values.spirv_shader_gen =
        ReadSetting(QStringLiteral("spirv_shader_gen"), false).toBool();
...
void Config::SaveRendererValues() {
    ...
    WriteSetting(QStringLiteral("async_command_recording"),
                 Settings::values.async_command_recording, true);
