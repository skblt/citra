...
SurfaceType SurfaceParams::GetFormatType(PixelFormat pixel_format) {
...
bool SurfaceParams::CheckFormatsBlittable(PixelFormat source, PixelFormat dest) {
    const SurfaceType source_type = GetFormatType(source);
    const SurfaceType dest_type = GetFormatType(dest);
...
bool SurfaceParams::IsExactMatch(const SurfaceParams& other_surface) const {
