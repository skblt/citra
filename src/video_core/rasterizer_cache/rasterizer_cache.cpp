...
RasterizerCacheOpenGL::RasterizerCacheOpenGL() {
    ...
    texture_filterer = std::make_unique<TextureFilterer>(Settings::values.texture_filter.GetValue(),
...
SurfaceSurfaceRect_Tuple RasterizerCacheOpenGL::GetFramebufferSurfaces(
    ...
    const bool texture_filter_changed =
        ...
        texture_filterer->Reset(Settings::values.texture_filter.GetValue(),
